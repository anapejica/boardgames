...
(defn login-page[]
  (html5
    ...
    [:body {:class "container" }
     [:h3  {:style "margin-top:20px; margin-bottom:40px; text-align: center"} "Login to Board Games web page"]
    (form/form-to [:post "/login"]
                 ...
                 (form/submit-button {:onclick "return beforeSubmit()" :class "btn btn-primary pull-right"  }  "Login")
                 [:br])
    ]
    )
  )
